const gallerySlug = new URLSearchParams(window.location.search).get("event") || "arjun-ayush";
...
async function loadGallery() {
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error(await getApiErrorMessage(response, "Gallery data could not be loaded."));
    }
